...
export interface HackReentrancyBankInterface extends utils.Interface {
  functions: {
...
export interface HackReentrancyBank extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HackReentrancyBankInterface;
